    ...
    <section id="contact" className="py-24 bg-slate-50 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="bg-white/80 backdrop-blur-md rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(34,197,94,0.2)] p-10 border border-white">
          ...
          <div className={`fixed top-5 right-5 z-[100] transition-all duration-500 transform ${toast.show ? "translate-x-0 opacity-100" : "translate-x-full opacity-0"}`}>
            <div className={`flex items-center gap-3 px-6 py-4 rounded-2xl text-white font-bold shadow-2xl ${toast.type === "success" ? "bg-emerald-600" : "bg-red-500"}`}>
