    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        <motion.button
          ...
          className="w-14 h-14 rounded-full shadow-xl flex items-center justify-center bg-green-500 hover:bg-green-600 text-white cursor-pointer"
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}
        ...
        {/* Pulse Ring */}
        <motion.div
          className="absolute bottom-0 right-0 w-14 h-14 rounded-full border-2 border-green-500 pointer-events-none"
          animate={{
            scale: [1, 1.5, 1.5],
            opacity: [0.5, 0, 0],
          }}
